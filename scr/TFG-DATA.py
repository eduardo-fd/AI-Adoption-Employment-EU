...
# Partimos de los datos oficiales extraidos de EUROSTAT sobre el uso de TIC en las empresas:
...
# Eliminamos varibles agregadas de nuestro dataset:
...
# Filtramos los indicadores de interes, en este caso los referentes al digital intensity index + use any AI technology:
...
# Eliminamos columnas, hacemos inner join (merge) y renombramos algunas columnas/paises:
...
# Agrupamos actividades economicas al nivel 1 (A-U):
...
# Eliminamos los que agrupan diferentes actividades economicas a nivel 1 (classificación indeterminable):
...
# Comprovamos si existen duplicados en nuestro dataset:
...
# Finalmente agrupamos por actividad economica:
...
#--------------------------------------------------------------------------------------------------------------------------------------------------------------
#                                                                       --- DATA EMPLOYMENT ---
# Partimos de los datos oficiales extraidos de EUROSTAT, sobre la estructura del empleo para diferentes paises europeos:
path = "lfsa_eisn2.xlsx"

# Establecemos un mapeo básico de las diferente actividades económicas y grupo jerarquico ocupacional:
...
# Iteramos para extraer los valores de interés y crear posteriormente un dataset homogeneo:
dataset = None
sheet_num = 2
